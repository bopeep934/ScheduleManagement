...
public class Schedule {//일정 객체. 일정 하나의 정보를 담고 있다.
 ...
 // @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-mm-dd")
    ...
    public Schedule(String writer, String password, LocalDateTime date,  LocalDateTime upDate, String toDo) {//최초 생성 시 생성자
        this.writer = writer;
    ...
    public Schedule(Long id, String writer, LocalDateTime date,  LocalDateTime upDate, String toDo) {//최초 생성 시 생성자
        this.id = id;
        this.writer = writer;
        this.date = date;
        this.upDate= upDate;
